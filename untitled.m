...
%
%   AUTHORS:
%   - John Itopa ISAH - 63362
%   - Blesso Danny Jeba Stephen - 63291
%
% Description:
...
%
% Usage:
% 1. Ensure the desired input audio file is saved in WAV format and placed
%    in the same directory as this script.
% 2. Modify the filename in the script to match the name of your input audio
%    file, if different from the default ('numero3.wav').
